...
from .views import SongFavoriteView, SongListView, SongDetailView, SongStreamView, SongDownloadView, PlaylistListView, PlaylistDetailView, PlaylistAddSongView, PlaylistRemoveSongView
...
urlpatterns = [
    ...
    path('songs/<int:pk>/favorite/', SongFavoriteView.as_view(), name='song-favorite'),
